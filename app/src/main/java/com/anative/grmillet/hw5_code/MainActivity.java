...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(0, 0, 0, "MyTexture Effect");
        menu.add(0, 1, 1, "Fog Effect");
        menu.add(0, 2, 2, "Blind Effect");
        menu.add(0, 3, 3, "Texture On/Off");
        menu.add(0, 4, 4, "Add bike");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case 0:
                mGLSurfaceView.mRenderer.headLightFlag = (mGLSurfaceView.mRenderer.headLightFlag+1) % 3;
                break;
            case 1:
            ...
            case 3:
                ...
                break;
            case 4:
                mGLSurfaceView.mRenderer.textureFlag = mGLSurfaceView.mRenderer.textureFlag + 1;
                break;
            default:
                return false;
        }
        ...
        switch (e.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_MOVE: // touch move
                ...
                if (e.getPointerCount() == 1) {
                    ...
                    float dist = ((previousX[0] - previousX[1]) * (previousX[0] - previousX[1]) + (previousY[0] - previousY[1]) * (previousY[0] - previousY[1])) -
                            ((currentX[0] - currentX[1]) * (currentX[0] - currentX[1]) + (currentY[0] - currentY[1]) * (currentY[0] - currentY[1]));
